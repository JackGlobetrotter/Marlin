...
#define STRING_CONFIG_H_AUTHOR "(JD, Ender-5 Plus)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.84,79.96, 799.20, 137.84 }
 ...
 *     O-- FRONT --+
 */
// TODO: Note on Creality Ender-5 Plus: Z offset must be adjusted (M851) every time once the probe has been loosen/unmounted.
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 46,46,46,46 } // (mm) Left, Front, Right, Back insets
